...
export default function ProcessoSeletivoPage() {
  return (
    <main className="px-8 py-16 text-lg max-w-7xl mx-auto">
      <h2 className="text-4xl font-bold text-primary">Processo Seletivo Coopera Esportes</h2>
      <p className="mt-4">
      Você pode participar da Coopera Esportes como bolsista. O processo de seleção é feito anualmente, durante um determinado período, e todos os candidatos que se encaixem em nossos critérios tem sua aplicação avaliada gratuitamente.
...
Acompanhe as novidades pelo nosso instagram <Link href="https://www.instagram.com/cooperaesportes" className="underline transition-colors hover:text-tertiary">@cooperaesportes</Link>.
      ...
      <h3 className="text-xl font-bold mt-6 mb-2 text-tertiary">1º FASE – CANDIDATURA</h3>
      ...
      <h3 className="text-xl font-bold mt-6 mb-2 text-tertiary">2º FASE – ENTREVISTA</h3>
      <ul className="list-disc ml-6">
